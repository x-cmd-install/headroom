...
[![x-cmd/install — headroom Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/headroom.svg?lang=zh)](https://x-cmd.com/install/headroom)
...
合计: **580,905** 行代码（覆盖前 5 种语言、共 **2099** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Python | 418,909 | 33,485 | 80,639 | 1529 |
| Json | 72,085 | 0 | 0 | 268 |
| Rust | 56,629 | 6,010 | 5,790 | 197 |
| JavaScript | 14,026 | 384 | 188 | 13 |
| TypeScript | 11,922 | 1,050 | 1,825 | 92 |

## 源代码

- **上游仓库**: <https://github.com/chopratejas/headroom>
- **官网**: <https://docs.headroomlabs.ai/docs>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `v0.38.0` (2026-09-21)
- **最近提交**: 2026-09-22
- **Release 含资产**: 8 个

## 流行度

- **Star**: 73,552 · **Fork**: 5,675 · **开放 issue**: 1,084 · **贡献者**: 271

## 累计统计

- **发布数**: 170 · **已合并 PR**: 1638 · **开放 PR**: 374 · **已关闭 issue**: 742 · **开放 issue**: 342 · **提交数**: 2821
...
| last60d | 2026-07-25 | 11 | 0 | 0 | 0 | 0 | 0 |
| 90d | 2026-06-25 | 16 | 0 | 0 | 0 | 0 | 0 |
...
headroom 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `headroom` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/headroom.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T04:52:55Z._
